...
tar_rule(<a href="#tar_rule-name">name</a>, <a href="#tar_rule-srcs">srcs</a>, <a href="#tar_rule-out">out</a>, <a href="#tar_rule-args">args</a>, <a href="#tar_rule-compress">compress</a>, <a href="#tar_rule-compressor">compressor</a>, <a href="#tar_rule-compressor_args">compressor_args</a>, <a href="#tar_rule-compute_unused_inputs">compute_unused_inputs</a>, <a href="#tar_rule-mode">mode</a>,
         <a href="#tar_rule-mtree">mtree</a>)
</pre>
...
| <a id="tar_rule-compressor"></a>compressor |  External tool which can compress the archive.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="tar_rule-compressor_args"></a>compressor_args |  Arg list for `compressor`.   | String | optional |  `""`  |
